...
export class Game {
  ...
  private restart(): void {
    ...
    this.spawnGraceLeft = GameConfig.spawnGraceSeconds;
    this.alive = true;
    this.gameOver.hide();
  }
  ...
  private frame(ts: number): void {
    ...
    this.renderer.render(this.player, this.aiCells, this.pellets, this.timeAlive, this.spawnGraceLeft);
    this.hud.update(this.player.mass, this.timeAlive, this.player.mass + this.timeAlive * 3, this.spawnGraceLeft);
  ...
  private update(dt: number): void {
    ...
    this.timeAlive += dt;
    this.spawnGraceLeft = Math.max(0, this.spawnGraceLeft - dt);
